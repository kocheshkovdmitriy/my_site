...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_name', models.CharField(blank=True, default='Аноним', max_length=20, verbose_name='Имя автора')),
                ('description', models.TextField(default='', verbose_name='Комментарий')),
                ('new', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.new', verbose_name='Новость')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
            ],
            options={
